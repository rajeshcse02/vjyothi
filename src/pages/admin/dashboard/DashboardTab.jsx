      ...
      <div className="container mx-auto">
        <div className="tab container mx-auto ">
          <Tabs defaultIndex={0} className=" ">
            <TabList className="md:flex md:space-x-2 flex gap-4 grid grid-cols-1 text-center md:justify-center mb-10 ">
              <Tab>
                <button
                  type="button"
                    ...
                    >
                      <tr>
                        ...
                        >
                          ...
                          <select
                            className="border text-sm p-1 rounded w-1/4 h-1/4"
                ...
                {order.map((allorder, index) => {
                  return (
                    ...
                    >
                      ...
                      {allorder.cartItems.map((item, tBodyKey) => {
            ...
            <TabPanel>
              <div className="relative overflow-x-auto mb-10">
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  {user
                    .sort((a, b) => b.time.seconds - a.time.seconds) // Sort by time.seconds (most recent first)
                    .map((item, index1) => {
                      const { name, uid, email, time } = item;
                      const signupDate = new Date(time.seconds * 1000); // Convert seconds to milliseconds
                      const formattedDate = `${String(
                        signupDate.getDate()
                      ).padStart(2, "0")}/${String(
                        signupDate.getMonth() + 1
                      ).padStart(2, "0")}/${signupDate.getFullYear()}`;
                      return (
                        <tbody key={uid}>
                          <tr
                            className="bg-gray-50 border-b dark:border-gray-700"
                      ...
                      <tbody>
                        {allorder.cartItems.map((item, itemIndex) => (
                          <React.Fragment key={itemIndex}>
                            {itemIndex === 0 && ( // Render details only for the first item
                              <tr
                                className="bg-gray-50 border-b dark:border-gray-700"
                                style={{
                                  backgroundColor:
                              ...
                              >
                                <td
                                  rowSpan={allorder.cartItems.length}
                                  className="px-6 py-4 text-black"
                                  style={{
                                    color: mode === "dark" ? "white" : "",
                                  }}
